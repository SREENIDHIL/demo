...
<form action="login.php" method="POST">
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <!-- <button class="dropdown-item" type="submit" id="dropmen" name="dropmen" value="changepsw" href="settings.php">Settings</button> -->
...
<body>
  ...
  <div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <li><a href="student_progress.html" >Student Progress</a></li>
      <li><a href="mentor_details.html" >Mentor Details</a></li>
