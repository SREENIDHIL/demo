...
<form action="login.php" method="POST">
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      <button class="dropdown-item" type="submit" id="dropmen" name="dropmen" value="changepsw" href="forgot_password.php">Settings</button>
...
<body>
  ...
  <div id="sidebarMenu">
    <ul class="sidebarMenuInner">
      ...
      <li><a href="mentors_list.html" >Mentor's List</a></li>
      <li><a href="mentor_mapping.html" >Mentor Mapping</a></li>
      <li><a href="mentor_feedback.html" >Mentor Feedback</a></li>
